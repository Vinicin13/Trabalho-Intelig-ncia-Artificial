...
def minimax(board, depth, alpha, beta, maximizing_player):
    ...
    if maximizing_player:
        ...
        for col in valid_locations:
            ...
            new_avaliacao = minimax(temp_board, depth - 1, alpha, beta, False)[1]
            if new_avaliacao > value:
                value = new_avaliacao
                column = col
        ...
        for col in valid_locations:
            ...
            new_avaliacao = minimax(temp_board, depth - 1, alpha, beta, True)[1]
            if new_avaliacao < value:
                value = new_avaliacao
                column = col
            beta = min(beta, value)
...
while not game_over:
    ...
    # Movimento da IA
        ...
        t1 = time.time()
        col, minimax_avaliacao = minimax(board, profundidade_minimax, -np.Inf, np.Inf, True)
        if valid_location(board, col):
